...
set "LOG_FILE=%GAME_DIR%debug_logs.txt"

mode con: cols=120 lines=40
title HIGHER OR LOWER DEBUG ENGINE [INITIALIZING...]
...
title HIGHER OR LOWER DEBUG ENGINE [CORE: !VERSION!]
...
:: ============================================================
::  6. RUN THE SCRIPT WITH THE FLAG
:: ============================================================
python main.py --debug

:: CAPTURE IMMEDIATELY before any other command runs!
set "TRIES=%errorlevel%"

:: Now you can change colors and log safely
color 02
